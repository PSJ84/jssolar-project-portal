...
-- CreateEnum
CREATE TYPE "ProjectPhase" AS ENUM ('CONTRACT', 'PERMIT', 'DESIGN', 'CONSTRUCTION', 'COMPLETION');

-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "DocumentCategory" AS ENUM ('CONTRACT', 'PERMIT', 'DRAWING', 'SCHEDULE', 'SITE_PHOTO', 'COMPLETION', 'OTHER');
...
CREATE TABLE "Project" (
    ...
    "currentPhase" "ProjectPhase" NOT NULL DEFAULT 'CONTRACT',
...
-- CreateIndex
CREATE INDEX "ProjectMember_invitedEmail_idx" ON "ProjectMember"("invitedEmail");
