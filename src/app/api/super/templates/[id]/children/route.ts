...
// POST /api/super/templates/[id]/children - 하위 템플릿 추가
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // 부모 템플릿 존재 확인 (메인 템플릿만 부모가 될 수 있음)
...
// PATCH /api/super/templates/[id]/children - 하위 템플릿 수정 (벌크)
...
// DELETE /api/super/templates/[id]/children - 하위 템플릿 삭제
